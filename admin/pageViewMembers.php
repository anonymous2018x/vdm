...
<?php
	...
	while($row = db_fetch_row($res)){
		...
		<tr class="<?php echo $tr_class; ?>">
			...
			<td class="text-left"><?php echo thisOr($row[7]); ?></td>
			<td class="text-left">
