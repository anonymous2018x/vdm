	...
	*/
	...
	function setupMembership(){
		...
		$membership_tables = array(
			...
			'membership_users' => "CREATE TABLE IF NOT EXISTS membership_users (memberID varchar(20) NOT NULL, passMD5 varchar(40), email varchar(100), signupDate date, groupID int unsigned, isBanned tinyint, isApproved tinyint, custom1 text, custom2 text, custom3 text, custom4 text, comments text, phone VARCHAR(20), PRIMARY KEY (memberID)) CHARSET " . mysql_charset,
		...
		if(!in_array('phone', array_keys($membership_users))) @db_query("ALTER TABLE membership_users ADD COLUMN phone VARCHAR(20)");
