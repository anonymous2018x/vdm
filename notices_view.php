...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFrom = "`notices` LEFT JOIN `managers` as managers1 ON `managers1`.`id`=`notices`.`manager` LEFT JOIN `projects` as projects1 ON `projects1`.`id`=`notices`.`project` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
	...
	$x->ColCaption = array("Notice", "Manager", "Project", "Worker", "Date");
	$x->ColFieldName = array('notice', 'manager', 'project', 'worker', 'date');
